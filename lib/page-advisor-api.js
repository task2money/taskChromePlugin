...
const PageAdvisorAPI = (() => {
  ...
  const ENDPOINTS = {
    ...
    pendingSuggestions:
      '/api/page-advisor/tenant_id/{tenantId}/pending-suggestions/?page_url={pageUrl}',
    confirmSuggestion:
      '/api/page-advisor/tenant_id/{tenantId}/suggestions/{suggestionId}/confirm/',
    dismissSuggestion:
      '/api/page-advisor/tenant_id/{tenantId}/suggestions/{suggestionId}/dismiss/',
  };
  ...
  function stampResolvedTraceId(payload, res, requestTraceId) {
    ...
    const tid = APIHttp.resolveTraceId(res, requestTraceId, '')
