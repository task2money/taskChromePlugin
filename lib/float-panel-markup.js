  ...
  return `
    ...
    <div id="taskplugin-float-panel" role="dialog" aria-modal="true" aria-labelledby="taskplugin-float-title">
      <div class="taskplugin-panel-header">
        <h1 id="taskplugin-float-title" class="taskplugin-float-heading">快速创建任务</h1>
      ...
      <div class="taskplugin-panel-body">
        ...
        <div class="taskplugin-form-group">
          <label for="taskplugin-workspace">工作空间</label>
        ...
        <fieldset class="taskplugin-form-group taskplugin-fieldset">
          <legend>项目 (单选)</legend>
          <div class="taskplugin-checkbox-list" id="taskplugin-projects" role="radiogroup" aria-required="true" aria-label="项目（单选）">
            <span style="color:#6c7086;font-size:11px;">请先选择工作空间</span>
          </div>
        </fieldset>
        <div class="taskplugin-form-group">
          <label for="taskplugin-title">标题</label>
          <input class="taskplugin-input" id="taskplugin-title" placeholder="任务标题" aria-required="true" required>
        </div>
        <div class="taskplugin-form-group">
          <div class="taskplugin-label-row">
            <label for="taskplugin-desc">描述</label>
        ...
        <div class="taskplugin-form-group">
          <label for="taskplugin-priority">优先级</label>
        ...
        <div class="taskplugin-form-group">
          <label for="taskplugin-progress">进度状态</label>
          <select class="taskplugin-select" id="taskplugin-progress">
            <option value="">-- 请先选择工作空间 --</option>
          </select>
        </div>
        <div class="taskplugin-form-group">
          <label for="taskplugin-deliverable">交付物类别</label>
          <select class="taskplugin-select" id="taskplugin-deliverable">
            <option value="">-- 请先选择工作空间 --</option>
          </select>
        </div>
        <div class="taskplugin-form-group">
          <label for="taskplugin-image">已安装镜像 <span id="taskplugin-image-required" hidden style="color:#f38ba8;font-size:10px;">*自动运行必选</span></label>
          <select class="taskplugin-select" id="taskplugin-image">
            <option value="">无</option>
          </select>
        </div>
        <div class="taskplugin-form-group">
          <label for="taskplugin-feature-params">智能体资源配置 <span style="color:#f38ba8;font-size:10px;">*绑定镜像后必填</span></label>
        ...
        <div class="taskplugin-form-group" id="taskplugin-personal-wrap" style="display:none">
          <label for="taskplugin-personal-config">个人配置</label>
          <select class="taskplugin-select" id="taskplugin-personal-config">
            <option value="">-- 请选择个人配置 --</option>
          </select>
        </div>
        <div class="taskplugin-form-group">
          <label for="taskplugin-due-date">截止日期</label>
        ...
        <div class="taskplugin-form-group">
          <label for="taskplugin-owner">负责人 <span style="color:#f38ba8;font-size:10px;">*必选</span></label>
        ...
        <div class="taskplugin-form-group">
          <label for="taskplugin-work-branch">工作分支 <span style="color:#6c7086;font-size:10px;font-weight:normal;">— 模板 / 仓库分支 / 可手写</span></label>
        ...
        <div class="taskplugin-form-group">
          <label for="taskplugin-merge-target">合并目标分支 <span style="color:#6c7086;font-size:10px;font-weight:normal;">— 模板 / 仓库分支 / 可手写</span></label>
    ...
    <div id="taskplugin-adjust-modal" class="taskplugin-modal" hidden>
      <div class="taskplugin-modal-card" role="dialog" aria-modal="true" aria-labelledby="taskplugin-adjust-title">
        ...
        <label for="taskplugin-adjust-input">调整期望</label>
        <textarea id="taskplugin-adjust-input" class="taskplugin-textarea" rows="4" placeholder="例如：把按钮改成红色、增大字号、调整间距..." aria-required="true"></textarea>
