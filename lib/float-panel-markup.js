  ...
  return `
    ...
    <div id="taskplugin-float-panel">
      ...
      <div class="taskplugin-panel-body">
        ...
        <div class="taskplugin-form-group">
          <label>逐仓基准分支 <span style="color:#6c7086;font-size:10px;font-weight:normal;">— 对齐工作面板；空则用项目默认分支</span></label>
          <div id="taskplugin-repo-bases" class="taskplugin-checkbox-list">
            <span style="color:#6c7086;font-size:11px;">一个任务一个项目，空则用项目默认分支</span>
          </div>
        </div>
        <div class="taskplugin-form-group">
