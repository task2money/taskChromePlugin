...
function floatWorkspaceSelectPlaceholder(action) {
  switch (action) {
    case 'loading':
      return tx('commonLoading');
    case 'login_required':
      return tx('floatPleaseLoginFirst');
    case 'refresh_page':
      return tx('floatRefreshRetryPlaceholder');
    case 'leave':
    default:
      return null;
  }
...
if (typeof globalThis !== 'undefined') {
  Object.assign(globalThis, {
    isUnauthedWorkspacePlaceholder, selectNeedsWorkspaceLoad,
    resolveFloatWorkspaceSelectAction, floatWorkspaceSelectPlaceholder,
  });
}
}
