  ...
  return `
    ...
    <div id="taskplugin-page-advisor-toolbar" class="taskplugin-page-advisor-toolbar" role="toolbar" aria-label="${e(PAGE_ADVISOR_A11Y.toolbarLabel)}" aria-describedby="taskplugin-page-advisor-hint">
      <div class="taskplugin-page-advisor-toolbar-drag" role="button" tabindex="0"
        aria-label="${e(paTx("paToolbarDragHandle"))}"
        title="${e(paTx("paToolbarDragTitle"))}"><span class="taskplugin-page-advisor-toolbar-drag-mark" aria-hidden="true">⋮⋮</span><span class="taskplugin-page-advisor-toolbar-title">${e(paTx("paToolbarNightTitle"))}</span></div>
