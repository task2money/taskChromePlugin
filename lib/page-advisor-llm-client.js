...
const PageAdvisorLLM = (() => {
  ...
  function buildChatMessages(page, skill) {
   ...
   * @param {{ fetchImpl?: typeof fetch, timeoutMs?: number, skill?: { title?: string, body?: string }|null }} [opts]
   */
    ...
    try {
      res = await fetchImpl(endpoint, {
        ...
        body: JSON.stringify({
          model,
          temperature: 0.3,
          messages: buildChatMessages(page, opts.skill),
        }),
        signal: ctrl?.signal,
      });
    } finally {
