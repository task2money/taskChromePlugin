...
(function (global) {
  ...
  const STEPS_EN = {
    overview: [
      ...
      'The popup and DevTools panel headers show the installed version. Unpacked developer-mode installs are marked Beta and checked against the GitHub Release; if a newer build exists, the header shows only the download link and hides the current version number.',
    ],
    login: [
