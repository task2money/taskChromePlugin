...
(function (global) {
  ...
  const STEPS_EN = {
    ...
    'page-optimization-suggest': [
      'Choose the call path under Auto-innovate agent: Direct with my key (free; Settings for an OpenAI-compatible Base URL, model, and API Key; works while signed out) or Platform backend (uses resources; sign-in required). If you have not chosen, direct is the default. The key stays on this device. Popup heading shows Alt+Shift+Z.',
