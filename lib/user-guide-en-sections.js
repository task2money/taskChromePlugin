...
(function (global) {
  ...
  const STEPS_EN = {
    ...
    login: [
      ...
      'After sign-in the extension loads your Profile default language (Chinese / English) for this help text. If unset, it keeps the device language. Change it on the website Profile page.',
    ],
    'float-create': [
    ...
    'page-optimization-suggest': [
      ...
      'Popup Prompt skills: click Settings. List includes “Do not apply a skill”; titles on their own line with Manage opening the workspace prompt-skills page; sync/edit/delete below. While signed out, skills stay on this device; after sign-in the popup loads the admin “new workspace default” skill if you have not chosen one yet, and can sync a workspace. Appended only on direct agent calls. API keys stay on this device.',
