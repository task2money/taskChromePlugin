...
(function (global) {
  ...
  const STEPS_EN = {
    ...
    'page-optimization-suggest': [
      ...
      'Popup Prompt skills (tendencies): click Settings to manage. Each skill can stay on this device or sync to a chosen workspace (members can see and edit). Appended only on direct agent calls; the JSON contract cannot be replaced. API keys stay on this device. Cloud fallback and create-task do not receive skills.',
    ...
    'popup-extras': [
      'Tracking toggle keeps requests across refresh. Float ball toggle at top. Click ! next to a section title for help. Auto-innovate agent heading shows Alt+Shift+Z; click Settings to save a local API key. Under Prompt skills click Settings to manage tendencies (this device or a workspace). Panel × does not hide ball.',
