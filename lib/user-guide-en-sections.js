...
(function (global) {
  ...
  const STEPS_EN = {
    ...
    'float-create': [
      ...
      'Submit creates the task; success resets the form and collapses the panel with a toast; errors stay in the panel footer.',
    ...
    'page-optimization-suggest': [
      'Sign in and set Alt+Z default workspace/project in the popup (float overrides when open), then Alt+Z (rebind in chrome://extensions/shortcuts).',
      ...
      'Timeouts / LLM errors show data-traceId for Loki (~75s client poll); use Retry.',
    ...
    'popup-extras': [
      'Tracking toggle keeps requests across refresh. Float ball toggle at top. Panel × does not hide ball.',
