...
(function (global) {
  ...
  const STEPS_EN = {
    ...
    'popup-extras': [
      'Tracking toggle keeps requests across refresh. Float ball toggle at top. Click ! next to a section title for help. Click Settings under Auto-innovate agent to save a local API key. Under Prompt skills click Settings to manage tendencies (this device or a workspace). Panel × does not hide ball.',
