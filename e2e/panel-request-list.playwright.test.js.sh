#!/usr/bin/env bash
# 运行 DevTools 面板请求列表冒烟测试（Playwright）
set -euo pipefail
...
"$PW_BIN" test -c e2e/playwright.config.js e2e/panel-request-list.playwright.test.js --timeout=60000
echo "panel-request-list.playwright.test.js: OK"
