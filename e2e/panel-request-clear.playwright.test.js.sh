#!/usr/bin/env bash
# 运行 DevTools 面板请求列表「清空」链路测试（Playwright）
set -euo pipefail
...
"$PW_BIN" test -c e2e/playwright.config.js e2e/panel-request-clear.playwright.test.js --timeout=60000
echo "panel-request-clear.playwright.test.js: OK"
