...
"$PW_BIN" test -c e2e/playwright.config.js e2e/float-out-of-stock-link.playwright.test.js --timeout=60000
echo "float-out-of-stock-link.playwright.test.js: OK"
