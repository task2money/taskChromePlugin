...
(() => {
  ...
  const queuedWrap = document.getElementById('taskplugin-queued-auto-run-wrap');
  const queuedInput = document.getElementById('taskplugin-queued-auto-run');
  const queuedError = document.getElementById('taskplugin-queued-auto-run-error');
  let workspaceScheduleEnabled = false;
  let membersData = [];
